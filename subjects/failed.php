            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="bg-white border border-red-300 p-6">
                    <div class="flex items-start space-x-3 mb-6">
                        ...
                        <div>
                            <h1 class="text-xl font-medium text-red-700 mb-1">Failed to delete subject</h1>
                            <p class="text-sm text-gray-600">This subject is linked to existing grades and cannot be deleted.</p>
                        </div>
                    </div>

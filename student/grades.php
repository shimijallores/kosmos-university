...
<body class="flex justify-content flex-col items-center">
  <div class="w-full md:max-w-3/4 mx-auto px-4">
    ...
    <div class="flex flex-col gap-4 mb-6 mt-6">
      <h1 class="text-2xl font-bold">Student Number: <span class="font-normal"><?= $student['student_number'] ?></span></h1>
    ...
    <div class="flex flex-col sm:flex-row gap-2 items-center justify-center md:justify-start mt-6">
      <button type="submit" class="bg-neutral-900 cursor-pointer text-white font-bold py-2 px-4 rounded w-full sm:w-auto">
        <a target="_blank" href="../grades/print.php?semester=<?= $current_semester ?>&student=<?= $student['student_number'] ?>">Print Grades</a>
      </button>
    </div>
  </div>
</body>

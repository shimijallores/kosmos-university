        ...
        <div class="bg-white border-b border-gray-200 px-6 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <h1 class="text-2xl font-extrabold text-gray-900">Edit Semester</h1>
                </div>
            </div>
        </div>
        ...
        <div class="p-6">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="bg-white border border-gray-300 p-6 mb-6">
                    <h2 class="text-lg font-medium text-gray-900 mb-2">Editing: <?= htmlspecialchars($semester['code']) ?></h2>
                    <p class="text-sm text-gray-600"><?= htmlspecialchars($semester['start_date']) ?> - <?= htmlspecialchars($semester['end_date']) ?></p>
                </div>
                    ...
                    <form action="update.php" method="POST" class="space-y-6">
                        ...
                        <div class="relative z-0 w-full group">
                            <input type="text"
                                name="code"
                                id="code"
                                value="<?= htmlspecialchars($semester['code']) ?>"
                        ...
                        <div class="flex items-center space-x-2">
                            <input type="checkbox"
                                name="summer"
                                id="summer"
                                class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-neutral-800"
                                <?= $semester['summer'] == 'Y' ? 'checked' : '' ?>>
                            <label for="summer" class="text-sm font-medium text-gray-700">Summer Semester</label>
                        </div>

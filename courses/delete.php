         ...
         <div class="px-6 py-6">
             ...
             <div class="flex items-start space-x-3">
                 ...
                 <div>
                     ...
                     <p class="text-sm text-gray-600">Are you sure you want to delete this course? This action cannot be undone and will permanently remove all associated records.</p>
                 </div>
             </div>
         </div>

...
<body class="flex justify-content flex-col items-center gap-y-6">
    <h1 class="text-3xl font-bold mt-6">Teachers Portal</h1>
    <a href="grading.php"
        class="bg-blue-500 text-center hover:bg-blue-700 w-40 cursor-pointer text-white font-bold py-2 px-4 rounded">Grading</a>
